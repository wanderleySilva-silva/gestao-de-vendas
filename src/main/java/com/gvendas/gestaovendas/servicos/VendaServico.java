...
import com.gvendas.gestaovendas.repositorios.ItemVendaRepositorio;
import com.gvendas.gestaovendas.repositorios.VendaRepositorio;
...
public class VendaServico extends AbstractVendaServico {
	...
	private Cliente validarClienteVendaExiste(Long codigoCliente) {
		Optional<Cliente> cliente = clienteServico.buscarClientePorCodigo(codigoCliente);
		if (cliente.isEmpty()) {
